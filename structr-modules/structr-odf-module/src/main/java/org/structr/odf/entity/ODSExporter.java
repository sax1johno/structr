...
public interface ODSExporter extends ODFExporter {
	...
	static class Impl { static { SchemaService.registerMixinType(ODSExporter.class); }}

	default void writeCollectionToCells(OdfTable sheet, OdfTableCell startCell, Collection col) {
	...
	default void writeObjectToCell(OdfTableCell cell, Object val) {
