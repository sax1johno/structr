...
public interface XMPPClient extends NodeInterface, XMPPInfo {
	...
	static class Impl { static { SchemaService.registerMixinType(XMPPClient.class); }}
	...
	@Export
	default RestMethodResult doSendMessage(final String recipient, final String message) throws FrameworkException {
	...
	@Export
	default RestMethodResult doSubscribe(final String recipient) throws FrameworkException {
	...
	@Export
	default RestMethodResult doUnsubscribe(final String recipient) throws FrameworkException {
	...
	@Export
	default RestMethodResult doConfirmSubscription(final String recipient) throws FrameworkException {
	...
	@Export
	default RestMethodResult doDenySubscription(final String recipient) throws FrameworkException {
	...
	@Export
	default RestMethodResult doJoinChat(final String chatRoom, final String nickname, final String password) throws FrameworkException {
	...
	@Export
	default RestMethodResult doSendChatMessage(final String chatRoom, final String message, final String password) throws FrameworkException {
